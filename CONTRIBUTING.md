...
<h3 align="center">Welcome to the PortfolioToResume project! 😍<br>
We appreciate your interest in contributing.😊<br> </h3>

First off, thank you for considering contributing to **PortfolioToResume!** We're excited to have you join our community. Every contribution, no matter how small, helps us build the best academic resource platform for students.
...
We expect all contributors to follow our [`Code of Conduct`](https://github.com/PortToResume/PortfolioToResume/blob/main/CODE_OF_CONDUCT.md).
...
By contributing to this project, you agree that your contributions will be licensed under the [`MIT License`](https://github.com/PortToResume/PortfolioToResume/blob/main/LICENSE.md).
...
*Your contributions earn points that count toward GSSoC'25 and your PortfolioToResume Leaderboard status!*
...
* ⌛ Reviews may take **24–72 hours** depending on activity. Thanks for your patience!
 ...
 > For Any Query, Send DM on LinkedIn [Divyansh Agrawal](https://www.linkedin.com/in/divyansh-agrawal-4556a0299/).
...
- Take a look at the existing [Issues](https://github.com/PortToResume/PortfolioToResume/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/PortToResume/PortfolioToResume/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
...
This **CONTRIBUTING.md** was prepared with **❤️** by **Divya Jain** for **PortfolioToResume** as part of the **GSSoC'25 program.**
...
<h3 align="center">
Thank you for contributing to PortfolioToResume 🌟
<br>
